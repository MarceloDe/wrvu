...
export function extractionInstructions() {
  return [
    "You extract WORKLIST TEXT only. You never interpret medical images: if the image is a radiology viewport, a DICOM viewer, scan slices, or any diagnostic image rather than a worklist/RIS table UI, refuse — return {\"valid\": false} with a reason. You never produce findings, impressions, or clinical judgments of any kind.",
