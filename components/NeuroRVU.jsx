...
import { TrackedExplorer } from "./analytics/Explorer.jsx";
...
function Timeline({ baseline, updateBaseline, updateSettings, log, settings, extraPeriods = [], reloadExtra, explorer, updateExplorer }) {
  ...
  // Deleting a shift stays here: it owns reloadExtra and the error state the explorer's
  // extra-duty table renders. The panel reports; the parent performs.
  ...
  return (
    <div className="space-y-5">
      ...
      <TrackedExplorer
        ...
        explorer={explorer} updateExplorer={updateExplorer}
        extraPeriods={extraPeriods}
        onDeletePeriod={delPeriod} deleteError={delError}
        palette={C}
      />
